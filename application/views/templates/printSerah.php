        ...
        <tbody>
            ...
            foreach ($detail as $dtl) : ?>
                <tr>
                    ...
                    <td style="border-left: 1px solid black;border-right: 1px solid black; border-bottom: 1px solid black;height: 27px; text-align: center;"><?= $dtl['banyak'] ?></td>
                </tr>
            <?php
                $index++;
            endforeach; ?>
    ...
    <div class="container">
        <table align="center" style="margin-top: 50px; margin-bottom: 50px;">
            <tr style="font-size: 20px;">
                <td>
                    Dengan ini pihak pertama menyatakan bahwa barang yang dipinjamkan dalam kondisi baik, dan <br> pihak pertama bersedia meminjamkan asset diatas sampai dengan <br>Tanggal <strong><u><?php $tgl1 = strtotime($master['tgl_pengembalian']);
                                                                                                                                                                                                        echo date('d-M-Y', $tgl1); ?></u></strong>,pukul <strong><u>17:30 WIB</u></strong>, Apabila ada kerusakan/kehilangan ditanggung oleh pihak kedua.
                </td>
            </tr>
            <tr style="font-size: 20px;">
                <td><br>Bandung, <u><?php $tgl1 = strtotime($master['tgl_peminjaman']);
                                    echo date('d-M-Y', $tgl1); ?></u></td>
            </tr>
        </table>
    </div>
